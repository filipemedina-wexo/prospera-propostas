...
const PasswordGate: React.FC<PasswordGateProps> = ({ onSuccess }) => {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center animate-fade-in px-4">
      ...
      <div className="mb-8 w-16 h-16 bg-[#8FA866] shadow-lg rounded-sm flex items-center justify-center text-white font-serif italic">
        Prospera
      </div>
      ...
      <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 w-full max-w-md relative overflow-hidden">
        ...
        <h2 className="text-2xl font-bold text-center text-slate-900 mb-2">Acesso ao Orçamento</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            {error && <p className="text-red-500 text-xs mt-2 ml-1">Senha incorreta. Tente "boraprosperar".</p>}
          </div>
